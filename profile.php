    ...
    foreach ($dirs as $dir) {
        ...
        if (file_exists($profilePath)) {
            ...
            if ($profileData) {
                ...
                $img = "";
                // Updated logic to check profile_image key first, then fallback
                if (isset($profileData['profile_image']) && !empty($profileData['profile_image'])) {
                    $img = $profileData['profile_image'];
...
<head>
    ...
    * { box-sizing: border-box; }
    ...
    body { margin: 0; padding-bottom: 40px; font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif; background-color: #f0f2f5; }
    ...
    .profile-right {
        ...
        min-width: 0; /* CRITICAL for overflow issues in flex children */
        overflow-wrap: break-word; /* Break long emails/names */
    }
    ...
    /* Thumbnails inside the horizontal gallery */
    ...
    .work-thumb:hover, .audio-thumb:hover {
    ...
    @media (max-width:760px){
        #mainProfile {
            ...
            border-radius: 0; /* Flatten edges slightly */
        }
        .main-profile-inner{
            flex-direction:column;
            align-items:center;
        ...
        .profile-right{
            width:100%;
            /* Ensure gallery doesn't push width */
            max-width: 100%;
        }
        .signin-bar-container { flex-direction: column; align-items: stretch; gap: 10px; border-radius: 0;}
        .signin-bar-container form { flex-direction: column; align-items: stretch; }
        .signin-bar-container .welcome-msg { text-align: center; }
        .container-container { padding-left: 15px; padding-right: 15px; width: 100% !important; box-sizing: border-box; }
        #artistSearchBar { width: 100% !important; }
    }
